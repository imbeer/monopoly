...
public class Tile {
    ...
    public void draw(Graphics2D g, Rectangle2D fieldBounds, int tilesInRow) {
        ...
        g.fill(DrawUtils.getPartOfBounds(bounds, 0, 0.4));
        g.setColor(new Color(0, 0, 0));
        DrawUtils.drawText(DrawUtils.NAME, NAME, g, DrawUtils.getPartOfBounds(bounds, 0, 0.4));
        DrawUtils.drawText(DrawUtils.PRICE, String.valueOf(PRICE) + " $", g, DrawUtils.getPartOfBounds(bounds, 0.5, 0.7));
        DrawUtils.drawText(DrawUtils.PRICE, String.valueOf(RENT) + " $", g, DrawUtils.getPartOfBounds(bounds, 0.7, 1));
    }
